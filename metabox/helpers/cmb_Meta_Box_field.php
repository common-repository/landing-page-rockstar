...
class cmb_Meta_Box_field {
	...
	public function render_field() {
		...
		$classes   .= $this->args('showfor') ? " showfor " . $this->args('showfor') : ''; 
		$classes   .= $this->args('hidefor') ? " hidefor " . $this->args('hidefor') : ''; 
		...
		if($this->args('showfor') || $this->args('hidefor')) {
      ...
      echo "</div>"; // close the opened primary div
      
      echo "<div class='feature_not_supported'><span class='cmb_metabox_description'>This theme doesn't support this feature</span></div>";
